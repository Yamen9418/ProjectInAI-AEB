function [scenario, egoVehicle] = scenario_12_AEB_CCRm_100overlap()
% scenario_12_AEB_CCRm_100overlap Returns the drivingScenario defined in
% the Designer
...
scenario = drivingScenario('StopTime', 7.5, 'SampleTime', 0.05);
