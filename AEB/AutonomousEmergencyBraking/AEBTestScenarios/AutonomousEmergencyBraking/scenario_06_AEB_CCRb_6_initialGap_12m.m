function [scenario, egoVehicle] = scenario_06_AEB_CCRb_6_initialGap_12m()
% scenario_06_AEB_CCRb_6_initialGap_12m Returns the drivingScenario defined
% in the Designer
...
scenario = drivingScenario('StopTime', 7.2, 'SampleTime', 0.05);
