function [scenario, egoVehicle] = scenario_10_AEB_CCRm_75overlap()
% scenario_10_AEB_CCRm_75overlap Returns the drivingScenario defined in the
% Designer
...
scenario = drivingScenario('StopTime', 7, 'SampleTime', 0.05);
