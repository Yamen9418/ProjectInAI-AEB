function [scenario, egoVehicle] = scenario_08_AEB_CCRm_50overlap()
% scenario_08_AEB_CCRm_50overlap Returns the drivingScenario defined in the
% Designer
...
scenario = drivingScenario('StopTime', 5.8, 'SampleTime', 0.05);
