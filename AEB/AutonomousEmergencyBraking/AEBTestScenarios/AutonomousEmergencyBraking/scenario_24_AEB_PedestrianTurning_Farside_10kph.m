function [scenario, egoVehicle] = scenario_24_AEB_PedestrianTurning_Farside_10kph()
% scenario_24_AEB_PedestrianTurning_Farside_10kph Returns the
...
scenario = drivingScenario('SampleTime', 0.05, 'StopTime', 15.5);
